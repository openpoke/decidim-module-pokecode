...
| `ALLOW_HTML_BLOCKS` | Disables HTML sanitization in the HTML content block, allowing raw HTML (including iframes, scripts, etc.) to be rendered as-is. Useful when admin users are fully trusted. | `true` | |
